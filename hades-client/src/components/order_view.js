...
class OrderView extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <h1>Open Orders</h1>
        <BootstrapTable options={options} data={this.state.orders} width={5} height={5}scrollTop={'Bottom'}>
        <TableHeaderColumn  isKey={true} dataField='orderId'>Order ID</TableHeaderColumn>
